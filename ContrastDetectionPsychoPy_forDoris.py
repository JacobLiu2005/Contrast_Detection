...
class ContrastDetectionTask:
    ...
    def __init__(self):
        ...
        intensities = {}
        intensities[0] = [0]
        intensities[30] =  [0,5,8,16,100]#[4,8,16,32,100]#[8,16,64,80,90,100]#[7,16,32,64,90,100]#[5, 8, 16, 64, 100]#[4,8,16,64,90,100]#[2,8,16,32,64,100]
        ...
        self.stim_time = expInfo['stim_time'] #in s
